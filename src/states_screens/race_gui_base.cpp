...
RaceGUIBase::RaceGUIBase()
{
    ...
    m_gauge_full = irr_driver->getTexture(file_manager->getAsset(FileManager::GUI, "gauge_full.png"), false, false, false);
    m_gauge_full_bright = irr_driver->getTexture(file_manager->getAsset(FileManager::GUI, "gauge_full_bright.png"), false, false, false);
    m_gauge_empty = irr_driver->getTexture(file_manager->getAsset(FileManager::GUI, "gauge_empty.png"), false, false, false);
    m_gauge_goal = irr_driver->getTexture(file_manager->getAsset(FileManager::GUI, "gauge_goal.png"), false, false, false);
