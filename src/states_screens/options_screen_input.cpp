...
{
    video::ITexture* icon1 = irr_driver->getTexture(file_manager->getAsset(FileManager::GUI, "keyboard.png"), false, false, false);
    video::ITexture* icon2 = irr_driver->getTexture(file_manager->getAsset(FileManager::GUI, "gamepad.png"), false, false, false);
    video::ITexture* icon3 = irr_driver->getTexture(file_manager->getAsset(FileManager::GUI, "gamepad_off.png"), false, false, false);
